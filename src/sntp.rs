...
pub async fn sntp_request(stack: &Stack<Device>, hostEndpoint: IpEndpoint, init_datetime: embassy_stm32::rtc::DateTime) -> embassy_stm32::rtc::DateTime {
    ...
    //info!("Sending packet.");
    let _ = ntpsocket.send_to(&ntp_tx.to_bytes(), hostEndpoint).await;
